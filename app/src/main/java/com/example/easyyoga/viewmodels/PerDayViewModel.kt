...
class PerDayViewModel : ViewModel() {
	...
	init {
		if (beginnerPlanList.isEmpty() && intermediatePlanList.isEmpty() && advancedPlanList.isEmpty()) {
			addBeginnerPlanList()
	...
	private fun addBeginnerPlanList() {
	...
	private fun addIntermediatePlanList() {
	...
	private fun addAdvancedPlanList() {
